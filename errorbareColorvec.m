function plotHandle=errorbare(sty,x,y,xbar,ybar,symbol,colorvec)
...
plot(vx,vy,esymbol,'markersize',20,'Color',colorvec)
end
...
p=plot(hx,hy,esymbol,'markersize',20,'Color',colorvec);
