function [p,S,mu] = weightedpolyfit(x,y,w,n)
% matlab's polyfit routine, with an addition of possibility to use weights
%   according to Klaus Betzler, Fitting in Matlab,
%   http://betzler.physik.uni-osnabrueck.de/Skripten/short/fitp.pdf
...
%   $Revision: 5.17.4.9 $  $Date: 2007/08/03 21:26:27 $
...
% added to matlab routine: use weights
w = w(:);
y = y.*w;
for j = 1:n+1
V(:,j) = w.*V(:,j);
